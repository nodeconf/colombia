  ...
  <section class="section-speakers">
    ...
    <div class="inner-wrap-desktop">
      ...
      <article class="section-speakers__content">
        ...
        <div class="section-speakers__data">
          <a href="http://" target="_blank" class="section-speakers__name">Anna Henningsen</a>
          ...
          <a href="https://twitter.com/addaleax" target="_blank" class="section-speakers__social">@ADDALEAX</a>
        </div>
      </article>
      ...
      <article class="section-speakers__content">
        ...
        <div class="section-speakers__data">
          <a href="#!" target="_blank" class="section-speakers__name">Tierney Cyren</a>
          <p class="section-speakers__description">
          ...
          <a href="https://twitter.com/bitandbang" target="_blank" class="section-speakers__social">@BITANDBANG</a>
        </div>
      </article>
    ...
    <div class="inner-wrap-desktop">
      ...
      <article class="section-speakers__content">
        ...
        <div class="section-speakers__data">
          <a href="#!" target="_blank" class="section-speakers__name">Kat Marchán</a>
          <p class="section-speakers__description">
            npm CLI maintainer; tc39 delegate; wealljs admin; cat mom  
          </p>
          <a href="https://twitter.com/maybekatz" target="_blank" class="section-speakers__social">@MAYBEKATZ</a>
        </div>
      </article>
      ...
      <article class="section-speakers__content">
        ...
        <div class="section-speakers__data">
          <a href="#!" target="_blank" class="section-speakers__name">James Snell</a>
          <p class="section-speakers__description">
            nearForm Community Engineering Manager & Node.js TSC 
          </p>
          <a href="https://twitter.com/jasnell" target="_blank" class="section-speakers__social">@JASNELL</a>
        </div>
      </article>
    ...
    <div class="inner-wrap-desktop">
      ...
      <div class="section-speakers__data">
        ...
        <a href="https://twitter.com/rauchg" target="_blank" class="section-speakers__social">@RAUCHG</a>
      </div>
    </article>
